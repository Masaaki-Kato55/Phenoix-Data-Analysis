---
title: "Pheonix General Data Dashboard"
output: 
  flexdashboard::flex_dashboard:
    orientation: column
    vertical_layout: fill
    source: https://github.com/Masaaki-Kato55/Phenoix-Data-Analysis
---
...
ggplot(data = poverty_status_female_long_above, aes(year, population)) +
       geom_line(color = "steelblue", size = 1) +
       geom_point(color="steelblue") + 
       labs(title = "Age Bracket Females for Above Poverty",
            subtitle = "Pheonix, Arizona",
            y = "Population", x = "Year") + 
       facet_wrap(~ age_bracket)  +
       theme(plot.title = element_text(hjust = 0.5),
...
ggplot(data = poverty_status_female_long_below, aes(year, population)) +
       geom_line(color = "steelblue", size = 1) +
       geom_point(color="steelblue") + 
       labs(title = "Age Bracket Females for Below Poverty",
            subtitle = "Pheonix, Arizona",
            y = "Population", x = "Year") + 
       facet_wrap(~ age_bracket)  +
       theme(plot.title = element_text(hjust = 0.5),
